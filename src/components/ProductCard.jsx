...
const ProductCard = ({title,image,description,price,category,key }) => {
...
<div className='relative flex flex-col gap-4 px-3 pt-3 pb-5 border-2 border-slate-200 w-72 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 group overflow-hidden'>
      ...
      <button className='flex items-center justify-center gap-2 px-4 py-2 bg-blue-500 text-white font-white font-semibold rounded-lg shadow -md <FaCartPlus /'>Add to cart</button>
    </div>
    );
};
